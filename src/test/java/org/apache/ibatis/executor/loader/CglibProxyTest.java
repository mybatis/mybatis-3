...
public class CglibProxyTest extends SerializableProxyTest {
  ...
  public void shouldSerizalizeADeserlizaliedProxy() throws Exception {
    ...
    assertTrue("author.class (" + author.getClass() + ") should be the same as author2.class (" + author2.getClass() + "), since the proxy does not have unloaded properties; it does not need to be proxied.", author.getClass().equals(author2.getClass()));
  }
