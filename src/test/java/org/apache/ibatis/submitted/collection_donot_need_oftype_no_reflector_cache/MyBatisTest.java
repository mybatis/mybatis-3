...
class MyBatisTest {
  ...
  static void setUp() throws Exception {
    ...
    try (Reader reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/collection_donot_need_oftype_no_reflector_cache/SqlMapConfig.xml")) {
      sqlSessionFactory = new SqlSessionFactoryBuilder().build(reader);
    }

    // populate in-memory database
    BaseDataTest.runScript(sqlSessionFactory.getConfiguration().getEnvironment().getDataSource(),
      "org/apache/ibatis/submitted/collection_donot_need_oftype_no_reflector_cache/CreateDB.sql");
  }
