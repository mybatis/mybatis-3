...
public interface PersonMapper {
  ...
  @ConstructorArgs({ @Arg(column = "id", javaType = Integer.class, id = true), @Arg(column = "firstName", javaType = String.class),
  ...
  @TypeDiscriminator(
      ...
      // Switch using enum constant name(PERSON or EMPLOYEE) at cases
      // attribute
      cases = {
