...
public class CacheTest {
   ...
   * executes "delete from A where id = 1" 4) SqlSession 2 executes "select * from A" Assert: Step 4
   * returns 1 row. (This case fails when caching is enabled.)
   */
  @Test
  ...
  /*
   * Test Plan: 1) SqlSession 1 executes "select * from A". 2) SqlSession 1 closes. 3) SqlSession 2
   * executes "delete from A where id = 1" 4) SqlSession 2 executes "select * from A" 5) SqlSession
   * 2 rollback 6) SqlSession 3 executes "select * from A" Assert: Step 6 returns 2 rows.
   */
  @Test
   ...
   * SqlSession 2 executes "select * from A". 6) SqlSession 3 closes. Assert: Step 6 returns 1 row.
   */
  @Test
