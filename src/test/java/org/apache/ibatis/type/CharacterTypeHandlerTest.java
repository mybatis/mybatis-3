...
public class CharacterTypeHandlerTest extends BaseTypeHandlerTest {
  ...
  private static final TypeHandler TYPE_HANDLER = new CharacterTypeHandler();
  ...
  public void shouldGetResultFromResultSet() throws Exception {
    ...
    assertEquals('a', TYPE_HANDLER.getResult(rs, "column"));
    mockery.assertIsSatisfied();
  }
  ...
  public void shouldGetResultFromCallableStatement() throws Exception {
    ...
    assertEquals('a', TYPE_HANDLER.getResult(cs, 1));
    mockery.assertIsSatisfied();
  }
