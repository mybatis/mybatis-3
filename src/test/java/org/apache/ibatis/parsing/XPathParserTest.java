...
class XPathParserTest {
  ...
  /**
   * @see <a href="https://github.com/mybatis/mybatis-3/issues/2080">issue 2080</a>
   */
  @Test
  void complexToString() {
    ...
    XPathParser parser = new XPathParser(xmlString);

    XNode xNode = parser.evalNode("/mapper/select");
    assertEquals(ex.trim(),xNode.toString().trim());
