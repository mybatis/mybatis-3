...
public class AESCryptogramImpl implements Cryptogram {
    ...
    public AESCryptogramImpl(String key) {
        try {
            ...
            throw new StringIndexOutOfBoundsException("SecretKey is too short, length required 16 at least");
        }
    ...
    public String decrypt(Object word) throws CryptogramFailException {
        ...
        try {
            ...
            cipher.init(Cipher.DECRYPT_MODE, this.secretKey, new IvParameterSpec(this.iv.getBytes(encoding)));
