...
| <ul><li>`GROUP_BY(String)`</li><li>`GROUP_BY(String...)`</li></ul>                                                                                                                                                                                                      | Appends new `GROUP BY` clause elements, concatenated by a comma. Can be called multiple times, which causes it to concatenate the new conditions each time with a comma.                                                                                                                                             |
...
| <ul><li>`ORDER_BY(String)`</li><li>`ORDER_BY(String...)`</li></ul>                                                                                                                                                                                                      | Appends new `ORDER BY` clause elements, concatenated by a comma. Can be called multiple times, which causes it to concatenate the new conditions each time with a comma.                                                                                                                                             |
| <ul><li>`LIMIT(String)`</li><li>`LIMIT(int)`</li></ul>                                                                                                                                                                                                                  | Appends a `LIMIT` clause. This method is valid when used together with SELECT(), UPDATE() and DELETE(). It is designed to be used together with OFFSET() when using SELECT(). (Available since 3.5.2)                                                                                                                |
| <ul><li>`OFFSET(String)`</li><li>`OFFSET(long)`</li></ul>                                                                                                                                                                                                               | Appends an `OFFSET` clause. This method is valid when used together with SELECT(). It is designed to be used together with LIMIT(). (Available since 3.5.2)                                                                                                                                                          |
| <ul><li>`OFFSET_ROWS(String)`</li><li>`OFFSET_ROWS(long)`</li></ul>                                                                                                                                                                                                     | Appends an `OFFSET n ROWS` clause. This method is valid when used together with SELECT(). It is designed to be used together with FETCH_FIRST_ROWS_ONLY(). (Available since 3.5.2)                                                                                                                                   |
| <ul><li>`FETCH_FIRST_ROWS_ONLY(String)`</li><li>`FETCH_FIRST_ROWS_ONLY(int)`</li></ul>                                                                                                                                                                                  | Appends a `FETCH FIRST n ROWS ONLY` clause. This method is valid when used together with SELECT(). It is designed to be used together with OFFSET_ROWS(). (Available since 3.5.2)                                                                                                                                    |
...
| `INTO_COLUMNS(String...)`                                                                                                                                                                                                                                               | Appends a columns phrase to an insert statement. This should be called together with INTO_VALUES().                                                                                                                                                                                                                  |
| `INTO_VALUES(String...)`                                                                                                                                                                                                                                                | Appends a values phrase to an insert statement. This should be called together with INTO_COLUMNS().                                                                                                                                                                                                                  |
| `ADD_ROW()`                                                                                                                                                                                                                                                             | Add new row for bulk insert. (Available since 3.5.2)                                                                                                                                                                                                                                                                 |


<span class="label important">NOTE</span> It is important to note that the SQL class writes `LIMIT`, `OFFSET`, `OFFSET n ROWS` and `FETCH FIRST n ROWS ONLY` clauses into the generated statement as is. In other words, the library does not attempt to normalize those values for databases that don’t support these clauses directly. Therefore, it is very important for users to understand whether or not the target database supports these clauses. If the target database does not support these clauses, then it is likely that using this support will create SQL that has runtime errors.
...
Since version 3.5.2, you can create an insert statement for bulk insert as follows:
...
Since version 3.5.2, you can create a select statement with a row-limiting clause as follows:
