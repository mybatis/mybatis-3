...
| `@StandaloneResultMap`                                                                                            | `Field`     | `<resultMap>`                                                                         | This annotation is used to create a standalone result map that can be reused by multiple statements. The annotation should be attached to an accessible static field in a mapper - a String field is best practice. The value of the field will be used as the resultMap id. The annotation can accept an array of `@Arg`, and/or an array of `@Result`, and/or a `@TypeDiscriminator`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
