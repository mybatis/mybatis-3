...
| `@NamedResultMap`                                                                                                 | `Type`      | `<resultMap>`                                                                         | This annotation is used to create a result map that is not tied directly to a select statement and can be reused by multiple statements. This is analogous to creating a `<resultMap>` in XML. The annotation should be attached to a type (typically a mapper interface). The annotation can accept an array of `@Arg`, and/or an array of `@Result`, and/or a `@TypeDiscriminator`. Any number of `@NamedRsultMap` annotations can be attached to a type.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
